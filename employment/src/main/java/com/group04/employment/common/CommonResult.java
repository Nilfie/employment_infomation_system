...
public class CommonResult<T> {
     ...
     * @param data 数据
     * */
    public static <T> CommonResult<T> generateSuccessResult(long count, List<Map<String, Object>> data){
        return new CommonResult<T>(ResultCode.SUCCESS.getCode(), ResultCode.SUCCESS.getMsg(), count, (T) data);
    }
